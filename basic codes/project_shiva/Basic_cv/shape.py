...
# initialize our drawing board  as a 300x300 with 3 channels, Red, Green,
# and Blue, with a black background
ground = np.zeros((300, 300, 3), dtype="uint8")

# draw a green line from the top-left corner of our canvas to the
# bottom-right
green = (0, 255, 0)
cv2.line(ground, (0, 0), (300, 300), green)
...
cv2.imshow("Ground", ground)
cv2.waitKey(0)
# load the image of your choice
image = cv2.imread("your_image_path/image.png")
 
# draw a circle around some point in the image, two filled in circles covering my eyes, and
# a rectangle surrounding making it a smile face
